...
sqrt(0.0499*(1-0.0499)/1002)*1.96
...
```{r spain-05-12}
# convert all spain information into a data frame
Spain.atheism <- filter(atheism,atheism$nationality == "Spain")
# converting explanatory variable to a categorical variable using as.factor() function
Spain.atheism$year <- as.factor(Spain.atheism$year)
Spain.atheism$response <- as.factor(Spain.atheism$response)
#find inference between 2005 and 2012 spain response

inference(y = response, x = year, data = Spain.atheism, type  = "ci", statistic = 'proportion',success = "atheist",method='theoretical')
...
# convert all us information into a data frame
us.atheism <- filter(atheism,atheism$nationality == "United States")
# converting explanatory variable to a categorical variable using as.factor() function
us.atheism$year <- as.factor(us.atheism$year)
us.atheism$response <- as.factor(us.atheism$response)
#find inference between 2005 and 2012 spain response

inference(y = response, x = year, data = us.atheism, type  = "ci", statistic = 'proportion',success = "atheist",method='theoretical')
#hypothesis test
inference(y = response, x = year, data = Spain.atheism, type  = 'ht', statistic = 'proportion', null= 0,alternative = 'twosided', method='theoretical', success = 'atheist')
...
```{r type1}
# if there was no change in the atheism index in the countries listed in Table 4,
# which are 39 countries in total, at 0.05 significance level, we expect to detect
# 39*0.05 =1.95 with no change in the atheism index by chance.
